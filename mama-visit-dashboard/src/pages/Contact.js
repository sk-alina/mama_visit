              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4}>
                  <Paper sx={{ p: 2, backgroundColor: 'warning.main', color: 'white' }}>
                    ...
                    <Typography variant="body2">
                      Эхо будет жить с тобой. Пожалуйста, корми его, люби и балуй! На улицу только с поводком. Свежую воду каждый день.Туалет у него роботизированный, еда и вода - тоже.
                    </Typography>
                  </Paper>
                </Grid>
              </Grid>
